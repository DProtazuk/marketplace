...
function chartRevenue() {
    ...
    LineChart_chartRevenue(labels_LineChart_week, id_LineChart_week, label1_LineChart_week, label1_color_LineChart_week, label1_data_LineChart_week);
}



function LineChart_chartRevenue(labels_LineChart, id_LineChart, label1_LineChart, label1_color_LineChart, label1_data_LineChart) {
    const multipleLineChart = document.getElementById(id_LineChart).getContext('2d');
    const myMultipleLineChart = new Chart(multipleLineChart, {
        type: 'line',
        data: {
