...
function WriteProductEndPagination() {
    ...
    $.ajax({
        url: "/backend/script/client/favorite.php",
        method: 'POST',
        dataType: 'json',
        data: {
...
function table_spisok(array) {
    $(".div_print_product").append("<div class=\"text-decoration-none text-white col-12 d-flex justify-content-between  border border-0 border-bottom border-secondary my-2 py-3 border-opacity-50\">\n" +
        ...
        "                                    <div class=\"px-3\"></div>\n" +
        "                                    <a href=\"/page/public/product/product?id=" + array['product_id'] + "\" class=\"col-8 text-white text-14 text-decoration-none\">" + array['product_name'] + "</a>\n" +
        ...
        "<a href=\"/page/public/shop/shop?id=" + array['shop_id'] + "\" class=\"text_blue text-decoration-none Medium my-auto mx-2\">" + array['shop_name'] + "</a>" +
        "<a href=\"/backend/script/client/favorite.php?id=" + array['product_id'] + "\" class=\"text-white text-14 text-decoration-none Medium my-auto mx-5 text_blue_hover\">Удалить из избранных</a><" +
        "/div>" +
...
function table_table(array) {
    $(".div_print_product").append("<div class=\"w-22 d-flex align-items-center  mb-5\" style=\"min-height: 334px; max-height: 334px;\">\n" +
        " <a href=\"/page/public/product.php\" class=\"text-decoration-none my-auto text-white col-12 rounded-4 div-product position-relative\" style=\"min-height: 314px; max-height: 314px; background-color:  !important;\">\n" +
