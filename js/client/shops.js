...
function queryShops(searchInput, filterShops, filterCategory, page){
    $.ajax({
        url: "/backend/script/client/shops.php",
        method: 'POST',
        dataType: 'json',
        data: {
        ...
        success: function(data){
            if (data !== 0) {
                ...
                data['array'].forEach(function (array) {
                    $(".div-write-shops").append("<a href=\"/page/public/shop/shop?id="+array['id']+"\" class=\"text-white text-decoration-none shops_mini w-18 rounded-3 my-2 pb-2\" style=\"border: 1px solid rgba(255, 255, 255, 0.1);\">\n" +
