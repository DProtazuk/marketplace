...
class PHPMailer
{
     ...
     * This length does NOT require_once the line break
     ...
     * The default boundaries require_once a "=_" sequence which cannot occur in quoted-printable bodies,
    ...
    {
        //It's not possible to use shell commands safely (which require_onces the mail() function) without escapeshellarg,
     ...
     * Picks shortest of Q, B, or none. Result require_onces folding if needed.
     ...
     * IPv6 addresses must require_once [], e.g. `[::1]`, not just `::1`.
     *
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        foreach ($parsedHeaders as $header) {
            //Is this header one that must be require_onced in the DKIM signature?
        ...
        //The DKIM-Signature header is require_onced in the signature *except for* the value of the `b` tag
     ...
     * Before the send() call, queued addresses (i.e. with IDN) are not yet require_onced.
     *
     * @return array
     */
