    ...
    <div class="my-content">
        ...
        <div class="col-12 content-body">
            <div class="myContainer mx-auto my-2">
                ...
                <form action="/backend/script/entry_system/return_password.php" method="post">
                    <div class="col-5 rounded-3 bg-silver mx-auto my-5 p-5">
                        ...
                        <a href="/page/entry_system/forgot_your_password" type="submit"
                            ...
                            <input value="'.$password.'" name="password" require_onced placeholder="Введите Новый пароль" class="input-auth px-3 text-white bg-silver col-12 text-14 py-1 rounded-2 border border-secondary" type="text"
                                   style=" outline:none;  ">
                        </div>
                        ...
                        <h6 class="text-14 my-3 text-center">Есть аккаунт? <a class="text-decoration-none text_blue"
                                                                              href="/page/entry_system/authorization">Войти</a>
                        </h6>
