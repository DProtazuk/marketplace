            ...
            <div class="myContainer mx-auto my-2">
                ...
                <div class="col-12 d-flex text-secondary fw-bolder mb-4">
                    ...
                    <a href="/page/admin/users/seller/product?id=<?php echo $_GET['id'] ?>"
                       class="text-14 cursor text-secondary text-decoration-none mx-3 white-hover">Товары</a>
                    <a href="/page/admin/users/seller/decoration?id=<?php echo $_GET['id'] ?>"
                       class="text-14 cursor text-white text-decoration-none mx-3 white-hover">Оформление</a>
                </div>


                <form id="form_shop" action="/backend/script/admin/users/seller/decoration.php" method="post" enctype="multipart/form-data">

                    <?php

                    $shop = new Shop();
                    $array = $shop->SelectMyShop($_GET['id']);
                    ...
                    if($array){
                        ...
                        echo '<input type="hidden" name="action" value="update_shop"><input type="hidden" name="id" value="'.$_GET['id'].'">';
                    }
                    else {
                        $name = NULL;
                        $heading = NULL;
                        ...
                        echo '<input type="hidden" name="action" value="create_shop"><input type="hidden" name="id" value="'.$_GET['id'].'">';
                    }
                    ?>
                    <div class="col-12">
