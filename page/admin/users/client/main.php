        ...
        <div class="col-12 content-body">
            <div class="myContainer mx-auto my-2">
                ...
                <div class="col-12 d-flex text-secondary fw-bolder mb-4">
                    <a href="/page/admin/users/client/main?id=<?php echo $_GET['id'] ?>" class="text-14 cursor text-white text-decoration-none white-hover mx-3">Общее</a>
                ...
                <div class="col-12 d-flex justify-content-between text-white">
                    ...
                    <div class="w-48 bg-silver rounded-4 shadow_status p-3">
